<template>
  <div>
    ...
    <p>
      默认主题的
      <RouterLink to="/zh/reference/default-theme/config.html#lastupdated"
        >lastUpdated</RouterLink
      >
      和
      <RouterLink to="/zh/reference/default-theme/config.html#contributors"
...
<span class="token punctuation">}</span>
    ...
    <h2 id="git-仓库" tabindex="-1">
      <a class="header-anchor" href="#git-仓库" aria-hidden="true">#</a> Git
      仓库
    </h2>
    <p>
      该插件要求你的项目在
      <a
        ...
        >Git 仓库<ExternalLinkIcon
      /></a>
      下，这样它才能从提交历史记录中收集信息。
    </p>
    <p>
      在构建站点时，你应该确保所有的提交记录是可以获取到的。举例来说， CI
      工作流通常会在克隆你的仓库时添加
      <a
      ...
      /></a>
      参数来避免拉取全部的提交记录，因此你需要禁用这个功能，以便该插件在 CI
      可以中正常使用。
    </p>
    <div class="custom-container warning">
      ...
      <p>
        ...
        <code v-pre>dev</code> 模式下禁用该插件来获取更好的开发体验。
      </p>
    </div>
...
<span class="token punctuation">---</span></span>
    ...
    <h2 id="页面数据" tabindex="-1">
      <a class="header-anchor" href="#页面数据" aria-hidden="true">#</a>
      页面数据
    </h2>
...
<span class="token punctuation">}</span>
    ...
    <ul>
      <li>
        ...
        <p>页面的贡献者信息。</p>
        <p>
          该属性将会包含 <a href="#gitinclude">gitInclude</a> 所列文件的贡献者。
        </p>
      </li>
    </ul>
  </div>
