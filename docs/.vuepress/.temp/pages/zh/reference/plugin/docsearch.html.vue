...
<span class="token punctuation">}</span>
    ...
    <h2 id="获取搜索索引" tabindex="-1">
      <a class="header-anchor" href="#获取搜索索引" aria-hidden="true">#</a>
      获取搜索索引
    </h2>
    <p>
      你需要
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        >提交你的网站 URL<ExternalLinkIcon
      /></a>
      来加入 DocSearch 项目。当你的索引成功创建后， DocSearch 团队会将
      <a href="#apikey">apiKey</a> 和
      <a href="#indexname">indexName</a>
      发送到你的邮箱。接下来，你就可以配置该插件，在 VuePress 中启用 DocSearch
      了。
    </p>
    <p>
      或者，你也可以
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        >运行你自己的爬虫<ExternalLinkIcon
      /></a>
      来创建索引，然后使用你自己的 <a href="#appId">appId</a>,
      <a href="#apikey">apiKey</a> 和
      <a href="#indexname">indexName</a> 来配置该插件。
    </p>
    <details class="custom-container details">
      <summary>官方爬虫配置示例</summary>
      <div class="language-javascript ext-js line-numbers-mode">
        <pre
          v-pre
          class="language-javascript"
...
<span class="token punctuation">}</span><span class="token punctuation">)</span>
      ...
      <p>
        ...
        >
        字段<strong>必须</strong>包含
        <code v-pre>'lang'</code>，否则该插件将无法正常工作。
      </p>
    </details>
    <div class="custom-container tip">
      <p class="custom-container-title">TIP</p>
      <p>
        如果你使用的不是默认主题，或者在使用 Docsearch
        的时候遇到了任何问题，你也可以检查上述的爬虫配置示例，然后前往
        <a
          href="https://crawler.algolia.com/admin/crawlers/"
          target="_blank"
          rel="noopener noreferrer"
          >Algolia Crawler<ExternalLinkIcon
        /></a>
        仓库，在你项目侧边栏中的 Editor 页面中修改你的配置。
      </p>
    </div>
    ...
    <ul>
      ...
      <li>
        <p>详情：</p>
        <p>
          从 DocSearch 团队收到的 <code v-pre>apiKey</code> ，或者由你自己生成。
        </p>
      </li>
      <li>
        <p>参考：</p>
    ...
    <ul>
      ...
      <li>
        ...
        <p>
          从 DocSearch 团队收到的
          <code v-pre>indexName</code> ，或者由你自己生成。
        </p>
      </li>
      <li>
        <p>参考：</p>
    ...
    <ul>
      <li>
        <p>
          类型： <code v-pre>Record&lt;string, DocsearchPluginOptions&gt;</code>
        </p>
      </li>
      <li>
        <p>详情：</p>
...
<span class="token punctuation">}</span>
    ...
    <ul>
      <li>
        ...
        <ul>
          <li>
            <RouterLink to="/zh/guide/i18n.html"
              >指南 &gt; 多语言支持</RouterLink
            >
          </li>
        </ul>
    ...
    <h2 id="样式" tabindex="-1">
      <a class="header-anchor" href="#样式" aria-hidden="true">#</a> 样式
    </h2>
    <p>
      你可以通过
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        >@docsearch/css<ExternalLinkIcon
      /></a>
      提供的 CSS 变量来自定义样式：
    </p>
...
<span class="token punctuation">}</span>
    ...
    <h2 id="组件" tabindex="-1">
      <a class="header-anchor" href="#组件" aria-hidden="true">#</a> 组件
    </h2>
    ...
    <ul>
      <li>
        ...
        <p>
          该插件会全局注册一个
          <code v-pre>&lt;Docsearch /&gt;</code> 组件，你可以不传入任何 Props
          来使用它。
        </p>
        <p>
          将该组件放置在你想要显示 docsearch
          按钮的地方。例如，默认主题将这个组件放在了导航栏的末尾。
        </p>
      </li>
    </ul>
    <div class="custom-container tip">
